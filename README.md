# Siren
WordPress Theme
以下为原作者[蜜汁路易](https://www.cssplus.org/)的话：（根据Fuzzz的主页地址改变，此介绍我也更新了他的主页地址）
Siren 是基于 Akina 主题修改而来的，感谢[Fuzzz](http://fui.im/)写出这么棒的主题（[查看原始主题](http://fui.im/)）。
应该属于Akina的娱乐版本吧，我也不知道为什么要改成这样，可能因为好看吧。

-------------------------------------- 这里是一个分割线=-= --------------------------------------

我只是一个什么都不懂的人，第一次看到这个主题的时候就被迷住了。可惜，Siren已经停止了更新。其实我觉得这个主题还是可以有更新的空间的，或许是因为痴迷吧！？

[默藍欲語](https://molan.msakura.org/)
